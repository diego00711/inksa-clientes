...
const HEALTH_URL = `${import.meta.env.VITE_API_URL || 'https://inksa-auth-flask-dev.onrender.com'}/api/health`;
const SLOW_MS = 3000;
const SECONDARY_MS = 5000;
const RETRY_MS = 60000;

export default function WakingUpScreen({ onReady }) {
  const [phase, setPhase] = useState('checking'); // 'checking' | 'slow' | 'retry'
