...
// nem se o componente remontar. Sem isto, qualquer remontagem (SW, StrictMode,
// re-render do shell) trazia de volta a tela branca da xícara POR CIMA de tudo
// (z-9999): foi a "tela em branco" ao abrir o chat no E2E.
...
export default function WakingUpScreen({ onReady }) {
  ...
  useEffect(() => {
    ...
    // Rede de seguranca ABSOLUTA: o timer da corrente de pings pode morrer
    // (cleanup do StrictMode, SW interceptando fetch) sem nunca chamar finish —
    // e a cortina ficava presa na tela. Este timeout independe da corrente.
