// Cliente avalia o restaurante. Padrão único do app: só estrelas + comentário
// opcional — sem tags, sem notas por categoria e sem formulário retrátil.
      ...
      <div className="bg-green-50 border border-green-200 rounded-lg p-4">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-green-700 text-xs">Obrigado pelo feedback sobre o pedido.</p>
          </div>
        </div>
      </div>
    );
    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div>
        ...
        <textarea
          ...
          placeholder="Conte como foi a comida e o atendimento..."
          rows={3}
          maxLength={200}
